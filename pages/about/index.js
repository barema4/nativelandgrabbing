    ...
    <div className="app-wrapper about-page">
      ...
      <div className="video-banner-container">
        <div className="video-banner__overlay">
          <iframe
            src={`https://www.youtube.com/embed/BIxd4NdnQPs?autoplay=1&modestbranding=1&controls=0`}
            frameborder="0"
            allow="autoplay"
          ...
          <ul>
            <li>
              <svg
                ...
                class="flex-shrink-0 w-6 h-6 md:w-8 md:h-8 text-tcn-green"
              >
                <path
            ...
            <li>
              ...
              First access to tickets for live events
            </li>
          </ul>
        </div>
      </div>
